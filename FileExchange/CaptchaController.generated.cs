...
namespace FileExchange.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CaptchaController : FileExchange.Controllers.CaptchaController
    {
        public T4MVC_CaptchaController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ShowOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);
